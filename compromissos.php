...
$sql = "
    ...
    (SELECT COUNT(*) FROM participacoes WHERE evento_id = eventos.evento_id) + 
    CASE WHEN usuario_id = :usuario_id THEN 1 ELSE 0 END AS inscritos
    FROM eventos
                            ...
                            <div class="card-content">
                                <div class="media">
                                    <div class="media-content">
                                        ...
                                        <p class="subtitle is-6">
                                            <strong>Data:</strong> <?= date('d/m/Y', strtotime($evento['evento_data'])) ?> |
                                            <strong>Hora:</strong> <?= date('H:i', strtotime($evento['evento_hora'])) ?> |
                                ...
                                <div class="buttons mt-3">
                                    <?php if ($isCriador): ?>
                                        ...
                                        <a href="ver_participantes.php?evento_id=<?= $evento['evento_id'] ?>" class="button is-info">Ver Participantes</a>
